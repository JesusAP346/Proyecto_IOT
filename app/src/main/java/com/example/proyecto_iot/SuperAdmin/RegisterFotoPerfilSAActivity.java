...
public class RegisterFotoPerfilSAActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_foto_perfil_saactivity); // Usa el layout que definiste
            ...
            service.subirImagen(body).enqueue(new Callback<UploadResponse>() {
                ...
                public void onResponse(Call<UploadResponse> call, Response<UploadResponse> response) {
                    if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                        ...
                        Toast.makeText(RegisterFotoPerfilSAActivity.this, "Error al subir imagen", Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onFailure(Call<UploadResponse> call, Throwable t) {
                    Toast.makeText(RegisterFotoPerfilSAActivity.this, "Fallo al subir imagen: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
