...
public class RegisterActivityDNISA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_dnisa);
    ...
    private void guardarCambios() {
        ...
        // Verificar si otro usuario ya tiene ese documento
