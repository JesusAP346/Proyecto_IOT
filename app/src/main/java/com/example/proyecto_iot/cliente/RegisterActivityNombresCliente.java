...
public class RegisterActivityNombresCliente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_nombres_cliente); // Asegúrate de usar el layout correcto
