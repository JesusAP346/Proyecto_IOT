...
public class MessageClienteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MessageClienteAdapter(List<Message> messageList, String currentUserId) {
    ...
    // ViewHolder para mensajes enviados por el cliente
    ...
    // ViewHolder para mensajes recibidos del administrador
