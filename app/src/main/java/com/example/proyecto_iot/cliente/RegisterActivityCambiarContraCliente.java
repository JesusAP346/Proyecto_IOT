...
public class RegisterActivityCambiarContraCliente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_cambiar_contra_cliente); // Asegúrate que este sea el nombre correcto
